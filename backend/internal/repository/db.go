...
{"type":"function","function":{"name":"list_images","description":"列举所有可用镜像","parameters":{"type":"object","properties":{}}}}
			...
			},
			{
				...
				ToolDefs: `[
{"type":"function","function":{"name":"list_volumes","description":"列举所有云硬盘及其详细信息。API: GET /v2/{project_id}/volumes","parameters":{"type":"object","properties":{}}}},
...
{"type":"function","function":{"name":"get_volume_detail","description":"查询指定云硬盘的详细信息(含存储后端、挂载信息)。API: GET /v2/{project_id}/volumes/{volume_id}","parameters":{"type":"object","properties":{"volume_id":{"type":"string","description":"云硬盘ID(可选，不传则返回全部)"}}}}},
...
{"type":"function","function":{"name":"list_volume_snapshots","description":"列举所有云硬盘快照。API: GET /v2/{project_id}/snapshots","parameters":{"type":"object","properties":{}}}},
